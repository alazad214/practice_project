    ...
    if (customLogoPath == null) {
      switch (provider) {
        case AuthButtonProvider.google:
          logoPath = 'assets/social/google.png';
          break;
        case AuthButtonProvider.facebook:
          logoPath = 'assets/social/facebook.png';
          break;
        case AuthButtonProvider.twitter:
          logoPath = 'assets/social/twitter.png';
          break;
        case AuthButtonProvider.apple:
          logoPath = 'assets/social/apple.png';
          break;
        case AuthButtonProvider.github:
          logoPath = 'assets/social/github.png';
          break;
        case AuthButtonProvider.linkedin:
          logoPath = 'assets/social/linkedin.png';
          break;
        case AuthButtonProvider.microsoft:
          logoPath = 'assets/social/microsoft.png';
          break;
        case AuthButtonProvider.instagram:
          logoPath = 'assets/social/instagram.png';
          break;
        case AuthButtonProvider.discord:
          logoPath = 'assets/social/discord.png';
          break;
      }
    }

    final imageWidget = disableIcon
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
              color: borderColor ?? Colors.blue, width: borderWidth ?? 1),
        ),
        child: Row(
          mainAxisSize: MainAxisSize.min,
          mainAxisAlignment: MainAxisAlignment.center,
          children: iconSide == IconSide.left
